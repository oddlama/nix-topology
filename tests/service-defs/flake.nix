{
  ...
  outputs =
    ...
    let
      ...
      dummyPrivateKey = pkgs.writeText "dummy-private-key" ''
        -----BEGIN OPENSSH PRIVATE KEY-----
        
    ...
    in
    {
      ...
      checks.${system}.service-defs =
        ...
        pkgs.runCommand "check-service-defs"
          ...
          ''
            echo "Topology evaluation successful"
            echo "Services extracted from configuration"
            touch $out
          '';
    };
}
